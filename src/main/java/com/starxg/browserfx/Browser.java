...
//      txtUrl.setText("http://baidu.com/");
//      load(txtUrl.getText());
   // txtUrl.setText("http://cimpbpaas.dev.pab.com.cn/web/cimp/portal-fat7/#/");
    ...
    private void load(String url) {
        try {
            ...
            webView.load("http://cimpbpaas.dev.pab.com.cn/web/cimp/portal-fat7/#/");
        }
    }
